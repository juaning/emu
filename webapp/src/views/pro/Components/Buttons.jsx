              ...
              <GridContainer>
                <GridItem xs={12} sm={4} md={4}>
                  <Button color="twitter">
                    <i
                      className={
                        `${classes.socialButtonsIcons} ${classes.marginRight} fab fa-twitter`
                      }
                    />{' '}
              ...
              <GridContainer>
                <GridItem xs={12} sm={4} md={4}>
                  <Button color="google">
                    <i
                      className={
                        `${classes.socialButtonsIcons} ${classes.marginRight} fab fa-google-plus-g`
                      }
                    />{' '}
                    Share on Google+
                  </Button>
                ...
                <GridItem xs={12} sm={1} md={1}>
                  <Button justIcon color="google" simple>
                    <i
                      className={
                        `${classes.socialButtonsIcons} ${classes.marginRight} fab fa-google`
                      }
                    />
                  </Button>
                </GridItem>
              ...
              <GridContainer>
                <GridItem xs={12} sm={4} md={4}>
                  <Button color="linkedin">
                    <i
                      className={
                        `${classes.socialButtonsIcons} ${classes.marginRight} fab fa-linkedin`
                      }
                    />{' '}
              ...
              <GridContainer>
                <GridItem xs={12} sm={4} md={4}>
                  <Button color="pinterest">
                    <i
                      className={
                        `${classes.socialButtonsIcons} ${classes.marginRight} fab fa-pinterest`
                      }
                    />{' '}
                    Pint it · 212
                  </Button>
              ...
              <GridContainer>
                <GridItem xs={12} sm={4} md={4}>
                  <Button color="youtube">
                    <i
                      className={
                        `${classes.socialButtonsIcons} ${classes.marginRight} fab fa-youtube`
                      }
                    />{' '}
                    View on Youtube
                  </Button>
                ...
                <GridItem xs={12} sm={1} md={1}>
                  <Button justIcon color="youtube" simple>
                    <i
                      className={
                        `${classes.socialButtonsIcons} ${classes.marginRight} fab fa-youtube-square`
                      }
                    />
                  </Button>
                </GridItem>
              ...
              <GridContainer>
                <GridItem xs={12} sm={4} md={4}>
                  <Button color="tumblr">
                    <i
                      className={
                        `${classes.socialButtonsIcons} ${classes.marginRight} fab fa-tumblr-square`
                      }
                    />{' '}
                    Repost
                  </Button>
              ...
              <GridContainer>
                <GridItem xs={12} sm={4} md={4}>
                  <Button color="github">
                    <i
                      className={
                        `${classes.socialButtonsIcons} ${classes.marginRight} fab fa-github`
                      }
                    />{' '}
                    Connect with Github
                  </Button>
              ...
              <GridContainer>
                <GridItem xs={12} sm={4} md={4}>
                  <Button color="behance">
                    <i
                      className={
                        `${classes.socialButtonsIcons} ${classes.marginRight} fab fa-behance-square`
                      }
                    />{' '}
                    Follow us
                  </Button>
                ...
                <GridItem xs={12} sm={1} md={1}>
                  <Button justIcon color="behance" simple>
                    <i
                      className={
                        `${classes.socialButtonsIcons} ${classes.marginRight} fab fa-behance`
                      }
                    />
                  </Button>
                </GridItem>
              ...
              <GridContainer>
                <GridItem xs={12} sm={4} md={4}>
                  <Button color="dribbble">
                    <i
                      className={
                        `${classes.socialButtonsIcons} ${classes.marginRight} fab fa-dribbble`
                      }
                    />{' '}
                    Find us on Dribble
                  </Button>
              ...
              <GridContainer>
                <GridItem xs={12} sm={4} md={4}>
                  <Button color="reddit">
                    <i
                      className={
                        `${classes.socialButtonsIcons} ${classes.marginRight} fab fa-reddit`
                      }
                    />{' '}
                    Repost · 232
                  </Button>
